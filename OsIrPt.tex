...
\frame{
	...
	\hline
	 ...
	 &  \begin{minipage}{.2\textwidth}
	 	\adjincludegraphics[width=\linewidth]{img/Osmium.jpg}
	 \end{minipage}
	 	& \begin{minipage}{.2\textwidth}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\adjincludegraphics[width=\textwidth]{img/Hesse.png}
		\end{column}
	\end{columns}
}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{itemize}
				...
				\item První příprava byla publikována roku 1982, kdy byl terč z bismutu bombardován jádry železa:
...
\frame{
	...
	\begin{itemize}
		...
		\item Prvek s nejvyšší hustotou, \ce{\rho = 22,562 g.cm^{-3}}.
	...
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[width=.8\textwidth]{img/osmium.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\begin{itemize}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Platina se používala už ve starověkém Egyptě.
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Krystal přírodního osmia z Uralu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Nugety přírodního iridia z Kalifornie}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.3\textheight]{img/Sperrylite-195702.jpg}
		\end{figure}
	\end{column}
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.3\textheight]{img/Sperrylite-222380.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Jako katalyzátor se využívá pro hydrogenace.
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Osmium_crystals.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Platinum-Iridium_meter_bar.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.4\textheight]{img/Ventury-jewellery.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				\item Oxid osmičelý, \ce{OsO4}, je nažloutlá, těkavá pevná látka.
				\item Je silně toxický, stopové nečistoty \ce{OsO2} způsobují nažloutlé zbarvení.
				\item Sublimuje za laboratorní teploty.
				\item Je izoelektronový s manganistanem.
		...
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[width=1.3\textwidth,rotate=90]{img/Osmium_tetroxide.jpg}
			\end{figure}
		\end{column}
	\end{columns}
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/Triosmiumdodecacarbonyl.png}
		\caption*{Struktura \ce{Os3(CO)12}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Fluorid osmistý byl připraven pouze jednou a to reakcí osmia s fluorem za vysoké teploty a tlaku. Pokud by se jeho existence prokázala, šlo by o třetí heptafluorid (\ce{IF7} a \ce{ReF7}).
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/IrF5tetramer.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item V oxidačním stavu IV známe pouze fluorid, chlorid nebyl dosud připraven, ale známe soli hexafluoridoiridičité, které jsou důležité výchozí látky v chemii iridia:
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Fotochemickou reakcí v argonové matrici při teplotě 6~K dochází k~přesmyku peroxokomplexu za vzniku nestabilního \ce{IrO4}.\footnote[frame]{\href{https://doi.org/10.1002/ange.200902733}{Formation and Characterization of the Iridium Tetroxide Molecule with Iridium in the Oxidation State +VIII}}
	\end{itemize}

	\begin{figure}
		\adjincludegraphics[width=.75\textwidth]{img/IrO4.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Square_planar.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Poprvé byla připravena v roce 1845, k léčbě se používá od roku 1978.
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Carboplatin-skeletal.png}
			\end{figure}
		\end{column}

		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Carboplatin.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.8\textwidth]{img/Pt-leciva.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/Aqua_regia.jpg}
	\end{figure}
	\vfill
}
